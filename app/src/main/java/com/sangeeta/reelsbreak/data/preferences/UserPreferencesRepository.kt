...
//        }
//
//    suspend fun setActiveMode(mode: ActiveBlockMode) = writeMutex.withLock {
//        context.dataStore.edit { prefs -> prefs[ActiveBlockMode.STRICT.value.let { UserPreferences.ACTIVE_MODE }] = mode.value }
//    }
//
//    suspend fun setStrictMode(enabled: Boolean) = writeMutex.withLock {
//        context.dataStore.edit { prefs -> prefs[UserPreferences.IS_STRICT_MODE] = enabled }
//    }
//
//    suspend fun setDailyReelLimit(limit: Int) = writeMutex.withLock {
//        context.dataStore.edit { prefs -> prefs[UserPreferences.DAILY_REEL_LIMIT] = limit }
//    }
//
//    suspend fun setDailyTimeLimitMinutes(minutes: Int) = writeMutex.withLock {
//        context.dataStore.edit { prefs -> prefs[UserPreferences.DAILY_TIME_LIMIT_MINUTES] = minutes }
//    }
//
//    suspend fun setNotificationsEnabled(enabled: Boolean) = writeMutex.withLock {
//        context.dataStore.edit { prefs -> prefs[UserPreferences.IS_NOTIFICATIONS_ENABLED] = enabled }
//    }
//
//    suspend fun setWeekendRelaxEnabled(enabled: Boolean) = writeMutex.withLock {
//        context.dataStore.edit { prefs -> prefs[UserPreferences.IS_WEEKEND_RELAX_ENABLED] = enabled }
//    }
//
//    suspend fun setBlockedPackages(packages: Set<String>) = writeMutex.withLock {
//        context.dataStore.edit { prefs -> prefs[UserPreferences.BLOCKED_PACKAGES] = packages }
//    }
//
//    suspend fun startFocusSession(endTimestampMillis: Long) = writeMutex.withLock {
//        context.dataStore.edit { prefs ->
//            prefs[UserPreferences.IS_FOCUS_ACTIVE] = true
//            prefs[UserPreferences.FOCUS_END_TIMESTAMP] = endTimestampMillis
//        }
//    }
//
//    suspend fun stopFocusSession() = writeMutex.withLock {
//        context.dataStore.edit { prefs ->
//            prefs[UserPreferences.IS_FOCUS_ACTIVE] = false
//            prefs[UserPreferences.FOCUS_END_TIMESTAMP] = 0L
//            prefs[UserPreferences.BLOCKED_PACKAGES] = emptySet()
...
//    }
//
//    suspend fun setSelectedFocusMinutes(minutes: Int) = writeMutex.withLock {
//        context.dataStore.edit { prefs -> prefs[UserPreferences.SELECTED_FOCUS_MINUTES] = minutes }
//    }
//
//    suspend fun incrementReelsWatched() = writeMutex.withLock {
//        context.dataStore.edit { prefs ->
//            val current = prefs[UserPreferences.REELS_WATCHED_TODAY] ?: 0
//            prefs[UserPreferences.REELS_WATCHED_TODAY] = current + 1
//        }
//    }
//
//    suspend fun addTimeSpentMillis(deltaMillis: Long) = writeMutex.withLock {
//        context.dataStore.edit { prefs ->
//            val current = prefs[UserPreferences.TIME_SPENT_TODAY_MILLIS] ?: 0L
//            prefs[UserPreferences.TIME_SPENT_TODAY_MILLIS] = current + deltaMillis
//        }
//    }
//
//    suspend fun setLimitResetPeriod(period: LimitResetPeriod) = writeMutex.withLock {
//        context.dataStore.edit { prefs -> prefs[UserPreferences.LIMIT_RESET_PERIOD] = period.value }
//    }
//
//    suspend fun setOverlayReminderEnabled(enabled: Boolean) = writeMutex.withLock {
...
//
//            val shouldReset = when (period) {
//                LimitResetPeriod.HOUR -> lastReset == 0L || (now - lastReset) >= 3600000L
//                LimitResetPeriod.DAY -> {
//                    if (lastReset == 0L) true else {
//                        val lastDate = Instant.ofEpochMilli(lastReset)
...
//    }
//
//    suspend fun markLimitExceededForCurrentWindow() = writeMutex.withLock {
//        val now = System.currentTimeMillis()
//        val period = limitResetPeriod.first()
//
//        context.dataStore.edit { prefs ->
...
class UserPreferencesRepository(private val context: Context) {
    ...
    // Thread synchronization lock token to completely eliminate out-of-order background updates
    private val writeMutex = Mutex()
    ...
    suspend fun setActiveMode(mode: ActiveBlockMode) = writeMutex.withLock {
        context.dataStore.edit { prefs -> prefs[UserPreferences.ACTIVE_MODE] = mode.value }
    }
