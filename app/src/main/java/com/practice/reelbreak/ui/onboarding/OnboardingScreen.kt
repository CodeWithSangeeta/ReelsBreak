...
private fun PermissionsPage(
    ...
    PageLayout(isCompact = isCompact) {
        ...
        PageHeading(
            ...
            subtitle = "ReelBreak needs Accessibility to detect and block reels",
            isCompact = isCompact
        )
        Spacer(modifier = Modifier.height(if (isCompact) 16.dp else 22.dp))
        PermissionRow(
...
private fun FeaturePill(icon: ImageVector, text: String) {
    Row(
        ...
        Text(
            text = text, color = Color.White.copy(alpha = 0.80f),
...
private fun ModeRow(
    ...
    title: String, desc: String, isCompact: Boolean
) {
    Row(
        modifier = Modifier
            .fillMaxWidth()
        ...
        Column(
            ...
            Text(
                text = desc, color = Color.White.copy(alpha = 0.52f),
...
private fun InfoStatCard(
    ...
    Column(
        ...
        Text(
            text = subtext, color = Color.White.copy(alpha = 0.45f),
...
private fun TipBox(text: String, isCompact: Boolean) {
    Row(
        ...
        Icon(
            imageVector = Icons.Filled.Lightbulb, contentDescription = null,
        ...
        Text(
            text = text, color = Color.White.copy(alpha = 0.58f),
            fontSize = if (isCompact) 11.sp else 12.sp,
            lineHeight = 17.sp
        )
    }
...
private fun PermissionRow(
    ...
    Row(
        ...
        Column(
            ...
            Text(
                text = description, color = Color.White.copy(alpha = 0.48f),
                fontSize = if (isCompact) 10.sp else 11.sp,
                lineHeight = 15.sp
            )
        }
        if (isGranted) {
            Box(
                ...
                Icon(
                    imageVector = Icons.Filled.Check, contentDescription = "Granted",
...
private fun ChecklistItem(
    ...
    Row(
        ...
        Text(
            text = text, color = Color.White.copy(alpha = 0.82f),
            fontSize = if (isCompact) 13.sp else 14.sp,
            fontWeight = FontWeight.Medium,
            modifier = Modifier.weight(1f)
        )
